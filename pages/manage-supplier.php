    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form action="http://<?php echo BASE_SERVER;?>/erp/pages/scripts/supplier/edit.php" method="POST" id="">
                        <div class="form-body">
...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="supplier_contact" name="supplier_contact" class="form-control" placeholder="Contact Number" r /> </div>
                            </div>
                            <div class="form-group clearfix">
...
<![endif]-->
    ...
    ?>
    <script>
        toastr["success"]("You have successfully deleted Supplier", "Supplier Deleted");
...
toastr.options = {
  ...
  "hideMethod": "fadeOut"
        ...
        //toastr["Success"]("You just Successsfully edited record","supplier Edit");
    ...
    ?>
    <script>
        toastr["success"]("You have successfully edited Supplier", "Supplier Edited");
