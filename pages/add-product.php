                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet light portlet-fit portlet-form bordered">
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <!-- BEGIN FORM-->
<form action="scripts/product/add.php" enctype="multipart/form-data" id="add_product_form" class="form-horizontal" method="post">
           ...
           <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="eoq" class="form-control" placeholder="Rate of Sale" value="0"/>
                    </div>
                </div>
            </div>
        </div>
