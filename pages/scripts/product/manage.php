...
//    }
//    else
//        $image_path = '<img class = "img-responsive" src="http://www.placehold.it/75x75/EFEFEF/AAAAAAA&amp; text=no+image" alt="" />';
//  $sub_array[] = $image_path;
    $sub_array[] = $row["product_id"].".".$row['image_extension'];     //for js columdefs commented
