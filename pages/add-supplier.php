...
<?php
    if(isset($_GET['q']))
    {
        if($_GET['q'] == 'success'){
            ...
            <button class='close' data-close='alert'></button> You have successfully inserted new Supplier. </div>";
        }
    else if($_GET['q'] == 'error'){
        
            echo"<div class='alert alert-danger'>
            <button class='close' data-close='alert'></button>Supplier with same Contact No already exists! </div>";
        }
...
?>                                       
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
<!--                                               <tetxtarea type="tetx" placeholder = "Address" class="form-control" row=3></tetxtarea>-->
                                                <input type="text" name="supplier_address" class="form-control" placeholder="Address">
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<![endif]-->
    ...
    <?php
    if(isset($_SESSION['statuss']) && $_SESSION['statuss'] == SUPPLIER_ADD_SUCCESS){
    ?>
    <script>
//        toastr["Info"]("You have successfully added Supplier", "Supplier Added")
...
toastr.options = {
  ...
  "hideMethod": "fadeOut"
        ...
        toastr["success"]("You have successfully added Supplier","Supplier Added");
