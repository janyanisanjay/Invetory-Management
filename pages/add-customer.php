...
<?php
    if(isset($_GET['q']))
    {
        if($_GET['q'] == 'success'){
            ...
            <button class='close' data-close='alert'></button> You have successfully inserted new Customer. </div>";
        }
    else if($_GET['q'] == 'error'){
        
            echo"<div class='alert alert-danger'>
            <button class='close' data-close='alert'></button>Customer with same Contact No already exists! </div>";
        }
...
<!--                                               <tetxtarea type="tetx" placeholder = "Address" class="form-control" row=3></tetxtarea>-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input name="customer_contact" type="text" class="form-control" placeholder="Contact No" /> </div>
                                                <div class="col-md-4"><label><span class="required"></span></label></div>
                                        </div>
                                        <div class="form-group">
...
<![endif]-->
    ...
    <?php
    if(isset($_SESSION['statuss']) && $_SESSION['statuss'] == CUSTOMER_ADD_SUCCESS){
    ?>
    <script>
...
toastr.options = {
  ...
  "hideMethod": "fadeOut"
        ...
        toastr["success"]("You have successfully added Customer","Customer Added");
