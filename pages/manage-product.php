    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form action="http://<?php echo BASE_SERVER;?>/erp/pages/scripts/product/edit.php" method="POST" id="">
                        <div class="form-body">
...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="eoq" name="eoq" class="form-control" placeholder="HSN Code" readonly/> </div>
                            </div>
...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="rate_of_sale" name="rate_of_sale" class="form-control" placeholder="GST Rate"  /> </div>
                            </div>
                            <div class="form-group clearfix">
...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="additional_specification" name="additional_specification" class="form-control" placeholder="GST Rate" readonly /> </div>
                            </div>
...
<![endif]-->
    ...
    ?>
    <script>
        toastr["success"]("You have successfully edited Product", "Product Edit")
...
toastr.options = {
  ...
  "hideMethod": "fadeOut"
        ...
        toastr["Success"]("You just Successsfully edited record","Product Edit")
