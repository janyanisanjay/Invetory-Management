    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form action="http://<?php echo BASE_SERVER;?>/erp/pages/scripts/category/edit.php" method="POST" id="">
                        <div class="form-body">
                          ...
                          <button class="close" data-close="alert"></button> You have some form errors. Please check below. </div>
                           ...
                           <div class="form-group clearfix">
                                ...
                                <div class="col-md-9">
                                    <input type="hidden" id="edit_category_id" name="category_id" class="form-control" placeholder="Category ID" /> 
                                </div>
                            </div>
                            <div class="form-group clearfix">
...
<![endif]-->
    ...
    ?>
    <script>
        toastr["success"]("You have successfully edited Category", "Category Edit")
...
toastr.options = {
  ...
  "hideMethod": "fadeOut"
        ...
        toastr["Success"]("You just Successsfully edited record","category Edit")
