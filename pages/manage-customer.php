    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form action="http://<?php echo BAS E_SERVER;?>/erp/pages/scripts/customer/edit.php" method="POST" id="">
                        <div class="form-body">
...
<span class="required"> * </span>
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="customer_contact" name="customer_contact" class="form-control" placeholder="Contact Number" r /> </div>
                            </div>
                            <div class="form-group clearfix">
...
<![endif]-->
    ...
    ?>
    <script>
        toastr["success"]("You have successfully deleted Customer", "Customer Deleted");
...
toastr.options = {
  ...
  "hideMethod": "fadeOut"
        ...
        //toastr["Success"]("You just Successsfully edited record","customer Edit");
    ...
    ?>
    <script>
        toastr["success"]("You have successfully edited Customer", "Customer Edited");
